...
if input.len == 3:
  for file in ["rebrand.nim", "README.md", "nimtemplate.nimble", "src/nimtemplate.nim", "src/nimtemplate/common.nim", "tests/test.nim", ".github/dependabot.yml", ".github/workflows/build.yml", ".github/workflows/documentation.yml", ".github/workflows/reuse.yml", ".github/workflows/nim-run/action.yml", ".gitignore"]:
